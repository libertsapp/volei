...
9. **Média de vitórias por partida (pedido do usuário, v8.8):** nova coluna "Vit./partida" (ícone `ti-ball-volleyball`, verde) = `vitoriasPartidas ÷ partidas`, 1 casa decimal com vírgula, e a conta escrita embaixo ("93 vit. em 19 partidas"). Fica depois de Aproveitamento e antes de Estrelas; entra em `metricas.vitorias`, e sem esse campo a coluna não existe. Com 5 colunas o corte para "2 por linha" sobe de 479px para 699px de largura do próprio cartão.
